...
%     'hill.png'
%     'man.png'
      'pepper_dark_noise_gaussian.png'
    ];
...
N2                  = 64;  %% maximum number of similar blocks (maximum size of the 3rd dimension of a 3D array)
...
lambda_thr3D        = 2.5; %% threshold parameter for the hard-thresholding in 3D transform domain
beta                = 4.0; %% parameter of the 2D Kaiser window used in the reconstruction

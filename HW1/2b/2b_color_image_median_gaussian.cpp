...
// g++ -o 2b 2b_color_image_median_gaussian.cpp

// ./2b rose_color_noise.raw output_2b_median_gaussian_n3.raw 3
// ./2b rose_color_noise.raw output_2b_median_gaussian_n5.raw 3
// ./2b rose_color_noise.raw output_2b_median_gaussian_n7.raw 3
// ./2b rose_color_noise.raw output_2b_median_gaussian_n9.raw 3
...

{
        ...
        for (j = 0; j < Size; j++) 
		{
            ...
            for(m = initial_N ; m <= end_N ; m ++)
			{
                for(l = initial_N ; l <= end_N ; l ++) 
				{
                    ...
                    Image_temp1 = Imagedata_R_channel[height_i][width_i][BytesPerPixel];
            ...
            Imagedata_denoisedR[i][j][BytesPerPixel] = Image_temp2[middle_value];
        }
    }
        ...
        for (j = 0; j < Size; j++) 
		{
            ...
            for(m = initial_N ; m <= end_N ; m ++)
			{
                for(l = initial_N ; l <= end_N ; l ++) 
				{
                    ...
                    Image_temp1 = Imagedata_G_channel[height_i][width_i][BytesPerPixel];
                    Image_temp2[t] = Image_temp1;
                    t = t + 1;
                }
            }
            ...
            Imagedata_denoisedG[i][j][BytesPerPixel] = Image_temp2[middle_value];
        }
    }
        ...
        for (j = 0; j < Size; j++) 
		{
            ...
            for(m = initial_N ; m <= end_N ; m ++)
			{
                for(l = initial_N ; l <= end_N ; l ++) 
				{
                    ...
                    Image_temp1 =  Imagedata_B_channel[height_i][width_i][BytesPerPixel];
                    Image_temp2[t] = Image_temp1;
                    t = t + 1;
                }
            }
            ...
            Imagedata_denoisedB[i][j][BytesPerPixel] = Image_temp2[middle_value];
        }
    }
        ...
        for (int j = 0; j < Size; j++) 
		{
            ...
            for(x = initial_N ; x <= end_N ; x ++) 
			{
                for(y = initial_N ; y <= end_N ; y ++) 
				{
                    ...
                    Image_temp4 = Imagedata_denoisedR[height_i][width_i][BytesPerPixel];
            ...
            Imagedata_denoised_R[i][j][BytesPerPixel] = (unsigned char) wp;
        }
    }
        ...
        for (int j = 0; j < Size; j++) 
		{
            ...
            for(x = initial_N ; x <= end_N ; x ++) 
			{
                for(y = initial_N ; y <= end_N ; y ++) 
				{
                    ...
                    Image_temp4 = Imagedata_denoisedG[height_i][width_i][BytesPerPixel];
                    Image_temp3[t] = Image_temp4;
                    t = t + 1;
                }
            }
            ...
            Imagedata_denoised_G[i][j][BytesPerPixel] = (unsigned char) wp;
        }
    }
	...
	*/
        ...
        for (int j = 0; j < Size; j++) 
		{
            ...
            for(x = initial_N ; x <= end_N ; x ++) 
			{
                for(y = initial_N ; y <= end_N ; y ++) 
				{
                    ...
                    Image_temp4 = Imagedata_denoisedB[height_i][width_i][BytesPerPixel];
                    Image_temp3[t] = Image_temp4;
                    t = t + 1;
                }
            }
            ...
            Imagedata_denoised_B[i][j][BytesPerPixel] = (unsigned char) wp;
        }
    }
	...
	psnr = 2.0 + (10 * (log10((255*255)/(mse / ((float)(Size * Size))))));

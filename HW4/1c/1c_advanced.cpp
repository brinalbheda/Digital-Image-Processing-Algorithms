//g++ -o 1c 1c_advanced.cpp
//./1c comb.raw output_1c_N30.raw 1 510 510
...
void PCA(double** energyArray1,double** energyArray2,double** energyArray3,double** energyArray4,double** energyArray5,double** energyArray6,double** energyArray7,double** energyArray8,double** energyArray9,double** energyArray10,double** energyArray11,double** energyArray12,double** energyArray13,double** energyArray14,double** energyArray15,double** energyArray16,double** energyArray17,double** energyArray18,double** energyArray19,double** energyArray20,double** energyArray21,double** energyArray22,double** energyArray23,double** energyArray24,double** energyArray25,int* label,int imageHeight,int imageWidth,unsigned char* outputArray)
{
    ...
    for(int i=0;i<imageHeight;i++)
    {
        for(int j=0;j<imageWidth;j++)
        {
            energyArray1[i][j]=energyArray1[i][j]/energyArray25[i][j];
            energyArray2[i][j]=energyArray2[i][j]/energyArray25[i][j];
            energyArray3[i][j]=energyArray3[i][j]/energyArray25[i][j];
            energyArray4[i][j]=energyArray4[i][j]/energyArray25[i][j];
            energyArray5[i][j]=energyArray5[i][j]/energyArray25[i][j];
            energyArray6[i][j]=energyArray6[i][j]/energyArray25[i][j];
            energyArray7[i][j]=energyArray7[i][j]/energyArray25[i][j];
            energyArray8[i][j]=energyArray8[i][j]/energyArray25[i][j];
            energyArray9[i][j]=energyArray9[i][j]/energyArray25[i][j];
            energyArray10[i][j]=energyArray10[i][j]/energyArray25[i][j];
            energyArray11[i][j]=energyArray11[i][j]/energyArray25[i][j];
            energyArray12[i][j]=energyArray12[i][j]/energyArray25[i][j];
            energyArray13[i][j]=energyArray13[i][j]/energyArray25[i][j];
            energyArray14[i][j]=energyArray14[i][j]/energyArray25[i][j];
            energyArray15[i][j]=energyArray15[i][j]/energyArray25[i][j];
            energyArray16[i][j]=energyArray16[i][j]/energyArray25[i][j];
            energyArray17[i][j]=energyArray17[i][j]/energyArray25[i][j];
            energyArray18[i][j]=energyArray18[i][j]/energyArray25[i][j];
            energyArray19[i][j]=energyArray19[i][j]/energyArray25[i][j];
            energyArray20[i][j]=energyArray20[i][j]/energyArray25[i][j];
            energyArray21[i][j]=energyArray21[i][j]/energyArray25[i][j];
            energyArray22[i][j]=energyArray22[i][j]/energyArray25[i][j];
            energyArray23[i][j]=energyArray23[i][j]/energyArray25[i][j];
            energyArray24[i][j]=energyArray24[i][j]/energyArray25[i][j];
            energyArray25[i][j]=energyArray25[i][j]/energyArray25[i][j];
        }
    }
    int b=0;
    for(int i=0;i<imageHeight;i++)
    ...
    for(int c=0;c<1;c++)
    {
        ...
        for(int i=0;i<imageHeight*imageWidth;i++)
        {
            ...
            dist[0]=sqrt(pow((featurevector[i][0]-meanArray[0][0]),2)+pow((featurevector[i][1]-meanArray[0][1]),2)+pow((featurevector[i][2]-meanArray[0][2]),2)+pow((featurevector[i][3]-meanArray[0][3]),2)+pow((featurevector[i][4]-meanArray[0][4]),2)+pow((featurevector[i][5]-meanArray[0][5]),2)+pow((featurevector[i][6]-meanArray[0][6]),2)+pow((featurevector[i][7]-meanArray[0][7]),2)+pow((featurevector[i][8]-meanArray[0][8]),2)+pow((featurevector[i][9]-meanArray[0][9]),2)+pow((featurevector[i][10]-meanArray[0][10]),2)+pow((featurevector[i][11]-meanArray[0][11]),2)+pow((featurevector[i][12]-meanArray[0][12]),2)+pow((featurevector[i][13]-meanArray[0][13]),2)+pow((featurevector[i][14]-meanArray[0][14]),2)+pow((featurevector[i][15]-meanArray[0][15]),2)+pow((featurevector[i][16]-meanArray[0][16]),2)+pow((featurevector[i][17]-meanArray[0][17]),2)+pow((featurevector[i][18]-meanArray[0][18]),2)+pow((featurevector[i][19]-meanArray[0][19]),2)+pow((featurevector[i][20]-meanArray[0][20]),2)+pow((featurevector[i][21]-meanArray[0][21]),2)+pow((featurevector[i][22]-meanArray[0][22]),2)+pow((featurevector[i][23]-meanArray[0][23]),2)+pow((featurevector[i][24]-meanArray[0][24]),2));
            
            dist[1]=sqrt(pow((featurevector[i][0]-meanArray[1][0]),2)+pow((featurevector[i][1]-meanArray[1][1]),2)+pow((featurevector[i][2]-meanArray[1][2]),2)+pow((featurevector[i][3]-meanArray[1][3]),2)+pow((featurevector[i][4]-meanArray[1][4]),2)+pow((featurevector[i][5]-meanArray[1][5]),2)+pow((featurevector[i][6]-meanArray[1][6]),2)+pow((featurevector[i][7]-meanArray[1][7]),2)+pow((featurevector[i][8]-meanArray[1][8]),2)+pow((featurevector[i][9]-meanArray[1][9]),2)+pow((featurevector[i][10]-meanArray[1][10]),2)+pow((featurevector[i][11]-meanArray[1][11]),2)+pow((featurevector[i][12]-meanArray[1][12]),2)+pow((featurevector[i][13]-meanArray[1][13]),2)+pow((featurevector[i][14]-meanArray[1][14]),2)+pow((featurevector[i][15]-meanArray[1][15]),2)+pow((featurevector[i][16]-meanArray[1][16]),2)+pow((featurevector[i][17]-meanArray[1][17]),2)+pow((featurevector[i][18]-meanArray[1][18]),2)+pow((featurevector[i][19]-meanArray[1][19]),2)+pow((featurevector[i][20]-meanArray[1][20]),2)+pow((featurevector[i][21]-meanArray[1][21]),2)+pow((featurevector[i][22]-meanArray[1][22]),2)+pow((featurevector[i][23]-meanArray[1][23]),2)+pow((featurevector[i][24]-meanArray[1][24]),2));
            
            dist[2]=sqrt(pow((featurevector[i][0]-meanArray[2][0]),2)+pow((featurevector[i][1]-meanArray[2][1]),2)+pow((featurevector[i][2]-meanArray[2][2]),2)+pow((featurevector[i][3]-meanArray[2][3]),2)+pow((featurevector[i][4]-meanArray[2][4]),2)+pow((featurevector[i][5]-meanArray[2][5]),2)+pow((featurevector[i][6]-meanArray[2][6]),2)+pow((featurevector[i][7]-meanArray[2][7]),2)+pow((featurevector[i][8]-meanArray[2][8]),2)+pow((featurevector[i][9]-meanArray[2][9]),2)+pow((featurevector[i][10]-meanArray[2][10]),2)+pow((featurevector[i][11]-meanArray[2][11]),2)+pow((featurevector[i][12]-meanArray[2][12]),2)+pow((featurevector[i][13]-meanArray[2][13]),2)+pow((featurevector[i][14]-meanArray[2][14]),2)+pow((featurevector[i][15]-meanArray[2][15]),2)+pow((featurevector[i][16]-meanArray[2][16]),2)+pow((featurevector[i][17]-meanArray[2][17]),2)+pow((featurevector[i][18]-meanArray[2][18]),2)+pow((featurevector[i][19]-meanArray[2][19]),2)+pow((featurevector[i][20]-meanArray[2][20]),2)+pow((featurevector[i][21]-meanArray[2][21]),2)+pow((featurevector[i][22]-meanArray[2][22]),2)+pow((featurevector[i][23]-meanArray[2][23]),2)+pow((featurevector[i][24]-meanArray[2][24]),2));
            
            dist[3]=sqrt(pow((featurevector[i][0]-meanArray[3][0]),2)+pow((featurevector[i][1]-meanArray[3][1]),2)+pow((featurevector[i][2]-meanArray[3][2]),2)+pow((featurevector[i][3]-meanArray[3][3]),2)+pow((featurevector[i][4]-meanArray[3][4]),2)+pow((featurevector[i][5]-meanArray[3][5]),2)+pow((featurevector[i][6]-meanArray[3][6]),2)+pow((featurevector[i][7]-meanArray[3][7]),2)+pow((featurevector[i][8]-meanArray[3][8]),2)+pow((featurevector[i][9]-meanArray[3][9]),2)+pow((featurevector[i][10]-meanArray[3][10]),2)+pow((featurevector[i][11]-meanArray[3][11]),2)+pow((featurevector[i][12]-meanArray[3][12]),2)+pow((featurevector[i][13]-meanArray[3][13]),2)+pow((featurevector[i][14]-meanArray[3][14]),2)+pow((featurevector[i][15]-meanArray[3][15]),2)+pow((featurevector[i][16]-meanArray[3][16]),2)+pow((featurevector[i][17]-meanArray[3][17]),2)+pow((featurevector[i][18]-meanArray[3][18]),2)+pow((featurevector[i][19]-meanArray[3][19]),2)+pow((featurevector[i][20]-meanArray[3][20]),2)+pow((featurevector[i][21]-meanArray[3][21]),2)+pow((featurevector[i][22]-meanArray[3][22]),2)+pow((featurevector[i][23]-meanArray[3][23]),2)+pow((featurevector[i][24]-meanArray[3][24]),2));
            
            dist[4]=sqrt(pow((featurevector[i][0]-meanArray[4][0]),2)+pow((featurevector[i][1]-meanArray[4][1]),2)+pow((featurevector[i][2]-meanArray[4][2]),2)+pow((featurevector[i][3]-meanArray[4][3]),2)+pow((featurevector[i][4]-meanArray[4][4]),2)+pow((featurevector[i][5]-meanArray[4][5]),2)+pow((featurevector[i][6]-meanArray[4][6]),2)+pow((featurevector[i][7]-meanArray[4][7]),2)+pow((featurevector[i][8]-meanArray[4][8]),2)+pow((featurevector[i][9]-meanArray[4][9]),2)+pow((featurevector[i][10]-meanArray[4][10]),2)+pow((featurevector[i][11]-meanArray[4][11]),2)+pow((featurevector[i][12]-meanArray[4][12]),2)+pow((featurevector[i][13]-meanArray[4][13]),2)+pow((featurevector[i][14]-meanArray[4][14]),2)+pow((featurevector[i][15]-meanArray[4][15]),2)+pow((featurevector[i][16]-meanArray[4][16]),2)+pow((featurevector[i][17]-meanArray[4][17]),2)+pow((featurevector[i][18]-meanArray[4][18]),2)+pow((featurevector[i][19]-meanArray[4][19]),2)+pow((featurevector[i][20]-meanArray[4][20]),2)+pow((featurevector[i][21]-meanArray[4][21]),2)+pow((featurevector[i][22]-meanArray[4][22]),2)+pow((featurevector[i][23]-meanArray[4][23]),2)+pow((featurevector[i][24]-meanArray[4][24]),2));
            
            dist[5]=sqrt(pow((featurevector[i][0]-meanArray[5][0]),2)+pow((featurevector[i][1]-meanArray[5][1]),2)+pow((featurevector[i][2]-meanArray[5][2]),2)+pow((featurevector[i][3]-meanArray[5][3]),2)+pow((featurevector[i][4]-meanArray[5][4]),2)+pow((featurevector[i][5]-meanArray[5][5]),2)+pow((featurevector[i][6]-meanArray[5][6]),2)+pow((featurevector[i][7]-meanArray[5][7]),2)+pow((featurevector[i][8]-meanArray[5][8]),2)+pow((featurevector[i][9]-meanArray[5][9]),2)+pow((featurevector[i][10]-meanArray[5][10]),2)+pow((featurevector[i][11]-meanArray[5][11]),2)+pow((featurevector[i][12]-meanArray[5][12]),2)+pow((featurevector[i][13]-meanArray[5][13]),2)+pow((featurevector[i][14]-meanArray[5][14]),2)+pow((featurevector[i][15]-meanArray[5][15]),2)+pow((featurevector[i][16]-meanArray[5][16]),2)+pow((featurevector[i][17]-meanArray[5][17]),2)+pow((featurevector[i][18]-meanArray[5][18]),2)+pow((featurevector[i][19]-meanArray[5][19]),2)+pow((featurevector[i][20]-meanArray[5][20]),2)+pow((featurevector[i][21]-meanArray[5][21]),2)+pow((featurevector[i][22]-meanArray[5][22]),2)+pow((featurevector[i][23]-meanArray[5][23]),2)+pow((featurevector[i][24]-meanArray[5][24]),2));
            
            dist[6]=sqrt(pow((featurevector[i][0]-meanArray[6][0]),2)+pow((featurevector[i][1]-meanArray[6][1]),2)+pow((featurevector[i][2]-meanArray[6][2]),2)+pow((featurevector[i][3]-meanArray[6][3]),2)+pow((featurevector[i][4]-meanArray[6][4]),2)+pow((featurevector[i][5]-meanArray[6][5]),2)+pow((featurevector[i][6]-meanArray[6][6]),2)+pow((featurevector[i][7]-meanArray[6][7]),2)+pow((featurevector[i][8]-meanArray[6][8]),2)+pow((featurevector[i][9]-meanArray[6][9]),2)+pow((featurevector[i][10]-meanArray[6][10]),2)+pow((featurevector[i][11]-meanArray[6][11]),2)+pow((featurevector[i][12]-meanArray[6][12]),2)+pow((featurevector[i][13]-meanArray[6][13]),2)+pow((featurevector[i][14]-meanArray[6][14]),2)+pow((featurevector[i][15]-meanArray[6][15]),2)+pow((featurevector[i][16]-meanArray[6][16]),2)+pow((featurevector[i][17]-meanArray[6][17]),2)+pow((featurevector[i][18]-meanArray[6][18]),2)+pow((featurevector[i][19]-meanArray[6][19]),2)+pow((featurevector[i][20]-meanArray[6][20]),2)+pow((featurevector[i][21]-meanArray[6][21]),2)+pow((featurevector[i][22]-meanArray[6][22]),2)+pow((featurevector[i][23]-meanArray[6][23]),2)+pow((featurevector[i][24]-meanArray[6][24]),2));
        ...
        double sum1[25]={0},sum2[25]={0},sum3[25]={0},sum4[25]={0},sum5[25]={0},sum6[25]={0},sum7[25]={0};
        for(int i=0;i<imageHeight*imageWidth;i++)
        {
            for(int j=0;j<25;j++)
            {
